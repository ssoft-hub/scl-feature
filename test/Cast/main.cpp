...
auto foo(MyData const &)
{
    return Result::LValueConst;
}
auto foo(MyData volatile &)
{
    return Result::LValueVolatile;
}
auto foo(MyData const volatile &)
{
    return Result::LValueConstVolatile;
}
auto foo(MyData &&)
{
...
auto foo(MyData const &&)
{
    return Result::RValueConst;
}
auto foo(MyData volatile &&)
{
    return Result::RValueVolatile;
}
auto foo(MyData const volatile &&)
{
    return Result::RValueConstVolatile;
}
...
auto bar(WrappedData &)
{
    return Result::LValue;
}
auto bar(WrappedData const &)
{
    return Result::LValueConst;
}
auto bar(WrappedData volatile &)
{
    return Result::LValueVolatile;
}
auto bar(WrappedData const volatile &)
{
    return Result::LValueConstVolatile;
}
auto bar(WrappedData &&)
