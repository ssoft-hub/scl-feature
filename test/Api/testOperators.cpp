...
#define DATA_UNARY_OPERATOR_INT_PROTOTYPE(symbol, refer) \
    void operator symbol(int) refer { ::std::cout << DATA_FUNC_INFO << ::std::endl; }
...
#define DATA_UNARY_OPERATOR_PROTOTYPE(symbol, refer) \
    void operator symbol() refer { ::std::cout << DATA_FUNC_INFO << ::std::endl; }
...
public:
    ...
    void valueMethod() { ::std::cout << DATA_FUNC_INFO << ::std::endl; }
    void valueConstMethod() const { ::std::cout << DATA_FUNC_INFO << ::std::endl; }
    void valueVolatileMethod() volatile { ::std::cout << DATA_FUNC_INFO << ::std::endl; }
    void valueConstVolatileMethod() const volatile { ::std::cout << DATA_FUNC_INFO << ::std::endl; }
...
void testWrapperBinaryOperators()
{
    ...
    // >(); testWrapperBinaryOperatorsSpec< const volatile _Left, const volatile
    // _Right >();
    ...
    // >(); testWrapperBinaryOperatorsSpec< const volatile _Right, const
    // volatile _Left >();
}
