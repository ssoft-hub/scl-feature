...
namespace ScL::Feature::Detail { template < typename _Refer > struct WrapperLockHelper; }
...
namespace ScL::Feature::Detail
{
    ...
    private:
        ...
        WrapperLockForNonWrapped ( const ThisType & other ) = delete;
...
namespace ScL::Feature::Detail
{
    ...
    private:
        WrapperLockForWrapped ( const ThisType & other ) = delete;
...
namespace ScL::Feature::Detail
{
    ...
    // Choice of a case
    template < typename _Refer >
    using WrapperLockSwitchCase = ::std::conditional_t< ::ScL::Feature::isWrapper< ::std::remove_reference_t< _Refer > >(),
                                                         WrappedCase,
                                                         NonWrappedCase >;
