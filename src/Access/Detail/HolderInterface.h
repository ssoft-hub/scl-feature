...
namespace ScL::Feature::Detail
{
    struct HolderInterface
    {
        ...
        {
            return ::ScL::Meta::isDetected<GuardStaticMethodStrictOperation, _Arguments...>();
        }
        ...
        {
            return ::ScL::Meta::isDetected<UnguardStaticMethodStrictOperation, _Arguments...>();
        }
        ...
        {
            return ::ScL::Meta::isDetected<ValueStaticMethodStrictOperation, _Arguments...>();
        }
