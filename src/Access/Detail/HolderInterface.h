...
namespace ScL { namespace Feature { namespace Detail
{
    struct HolderInterface
    {
        ...
        {
            using Holder = ::std::decay_t< _HolderRefer >;
            ::ScL::Feature::Detail::GuardHelper< _HolderRefer, is_guard_method_exists< Holder, void( _HolderRefer ) > >::guard( ::std::forward< _HolderRefer >( holder ) );
        }
        ...
        {
            using Holder = ::std::decay_t< _HolderRefer >;
            ::ScL::Feature::Detail::UnguardHelper< _HolderRefer, is_unguard_method_exists< Holder, void( _HolderRefer ) > >::unguard( ::std::forward< _HolderRefer >( holder ) );
        }
