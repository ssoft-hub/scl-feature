...
SCL_POSTFIX_UNARY_OPERATOR_WITH_ARGUMENTS_IMPLEMENTAION(->*, MemberIndirection)
SCL_BINARY_OPERATOR_IMPLEMENTAION(SCL_SINGLE_ARG(, ), Comma)

SCL_POSTFIX_UNARY_OPERATOR_WITH_ARGUMENTS_IMPLEMENTAION([], SquareBrackets)
...
#define SCL_POSTFIX_UNARY_OPERATOR_WITH_ARGUMENT(symbol, Invokable)                                \
    ...
    SCL_POSTFIX_UNARY_OPERATOR_PROTOTYPE_WITH_ARGUMENT(                                            \
        SCL_SINGLE_ARG(symbol), const &&, Invokable)                                               \
    SCL_POSTFIX_UNARY_OPERATOR_PROTOTYPE_WITH_ARGUMENT(                                            \
        SCL_SINGLE_ARG(symbol), volatile &&, Invokable)                                            \
    SCL_POSTFIX_UNARY_OPERATOR_PROTOTYPE_WITH_ARGUMENT(                                            \
        SCL_SINGLE_ARG(symbol), const volatile &&, Invokable)                                      \
    SCL_POSTFIX_UNARY_OPERATOR_PROTOTYPE_WITH_ARGUMENT(SCL_SINGLE_ARG(symbol), &, Invokable)       \
