    ...
    { \
     ...
     \
            ...
            { \
                ...
                static constexpr decltype(auto) invoke ( _WrapperRefer && value, _Arguments && ... arguments ) \
                { \
     ...
     \
                    constexpr bool holder_has_method_for_operator = ::ScL::Feature::Detail::Operator::Unary::doesOperator ## Invokable ## StaticMethodExist< Holder, HolderRefer, _Arguments && ... >(); \
