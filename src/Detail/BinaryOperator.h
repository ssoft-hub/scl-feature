    ...
    {                                                                                          \
        ...
        static constexpr bool                                                                  \
            value = ::ScL::Meta::isDetected< ::ScL::Meta::Invokable##UnstrictOperation,        \
                        ...
                        RightRefer>()                                                          \
            || ::ScL::Meta::isDetected<                                                        \
                Operator##Invokable##ForLeftWrapperStaticMethodStrictOperation,                \
                LeftHolder,                                                                    \
                LeftWrapperRefer,                                                              \
                RightRefer>();                                                                 \
        constexpr operator bool() const noexcept { return value; }                             \
    ...
    {                                                                                          \
        ...
        static constexpr bool                                                                  \
            value = ::ScL::Meta::isDetected< ::ScL::Meta::Invokable##UnstrictOperation,        \
                        ...
                        RightValueRefer>()                                                     \
            || ::ScL::Meta::isDetected<                                                        \
                Operator##Invokable##ForRightWrapperStaticMethodStrictOperation,               \
                RightHolder,                                                                   \
                LeftRefer,                                                                     \
                RightWrapperRefer>();                                                          \
        constexpr operator bool() const noexcept { return value; }                             \
    ...
    {                                                                                          \
        ...
        static constexpr bool                                                                  \
            is_right_compatible_with_left = ::ScL::Feature::isThisCompatibleWithOther<         \
                                                RightWrapper,                                  \
                                                LeftWrapper>()                                 \
            && (::ScL::Meta::isDetected<Operator##Invokable##StaticMethodStrictOperation,      \
                    LeftHolder,                                                                \
                    LeftWrapperRefer,                                                          \
                    RightWrapperRefer>()                                                       \
...
#define SCL_BINARY_OPERATOR_IMPLEMENTAION(symbol, Invokable)                                       \
    ...
    {                                                                                              \
        ...
        SCL_META_METHOD_DETECTION(operator##Invokable##ForLeftWrapper,                             \
            Operator##Invokable##ForLeftWrapper)                                                   \
        template <typename... _Arguments>                                                          \
        inline static constexpr bool doesOperator##Invokable##ForLeftWrapper##StaticMethodExist()  \
        {                                                                                          \
            return ::ScL::Meta::isDetected<                                                        \
                Operator##Invokable##ForLeftWrapper##StaticMethodStrictOperation,                  \
                _Arguments...>();                                                                  \
        }                                                                                          \
        SCL_META_METHOD_DETECTION(operator##Invokable##ForRightWrapper,                            \
            Operator##Invokable##ForRightWrapper)                                                  \
        template <typename... _Arguments>                                                          \
        inline static constexpr bool doesOperator##Invokable##ForRightWrapper##StaticMethodExist() \
        {                                                                                          \
            return ::ScL::Meta::isDetected<                                                        \
                Operator##Invokable##ForRightWrapper##StaticMethodStrictOperation,                 \
                _Arguments...>();                                                                  \
        }                                                                                          \
