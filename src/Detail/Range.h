...
// ::std::begin, ::std::cbegin, ::std::end, ::std::cend, ::std::size, ::std::ssize, ::std::data, ::std::cdata
...
#define SCL_RANGE_METHOD_PROTOTYPE( method, refer ) \
    ...
    { \
        ...
        using IteratorWrapper = ::ScL::Feature::Detail::Wrapper< IteratorType, ::ScL::Feature::Detail::Guard::RangeTool< RangeWrapperRefer > >; \
