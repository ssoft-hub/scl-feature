...
Устанавливает внутренний контекст типов, необходимый всем последующим макросам рефлексии.
Сгенерированные псевдонимы являются деталями реализации — не обращайтесь к ним напрямую.
